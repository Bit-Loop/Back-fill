...
warnings.warn(
    "cli.legacy_cli (scraper.py) is deprecated. Please use cli.chronox_cli instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Backfill and streaming controller (DEPRECATED: use cli.chronox_cli)")
...
def main() -> None:
    print("\n" + "="*80)
    print("WARNING: This CLI (scraper.py) is DEPRECATED")
    print("Please use: python -m cli.chronox_cli")
    print("="*80 + "\n")
